...
\item[3 ] Read a string-valued keyword and return the string length, the value string, 
    ...
    ffgkcs is the earlier version of ffgkcs. It only returns the value string length and
    ...
    first FLEN_COMMENT-1 characters of the comment.  It can read comments across
