...
optional pixel skipping factor): \verb-myimage.fits[101:200,301:400]- will
create and open a 100x100 pixel virtual image of that section of the
physical image, and \verb-myimage.fits[*,-*]- opens a virtual image which is
the same size as the physical image but has been flipped in the vertical
direction.
...
\begin{itemize}
\item
Delete a column or keyword by listing the name preceded by an
