...
\subsection{Row Filtering Specification}
    ...
    A temporary new FITS file is then created  which contains only those
    ...
    copied to the temporary file).  The original FITS file is closed and
    the new  temporary file  is opened  and  passed to  the  application
    program.
