...
On Windows PC computers, 2 files are included to help build the CFITSIO
library:  The makepc.bat file gives an example of how to build CFITSIO
with the Borland C++ v4.5 compiler.  This file will probably need to
be  edited to include the appropriate command switches if a different C
compiler or linker is used.  Also, the file cfitsio\_visualc.zip
contains the Microsoft Developer workspace files for building CFITSIO on
WindowsNT using Microsoft Visual C++ 5.0.  Refer to the enclosed README
...
\begin{verbatim}
  OPERATING SYSTEM           COMPILER
   ...
   Windows NT                 Microsoft Visual C++ v5.0
   OS/2                       gcc + EMX
