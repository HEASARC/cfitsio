...
point option for double variables.  The make\_dfloat.com and
...
written in the FITS array.  See Appendix B for the definition of the
...
\begin{description}
\item[9 ] Read elements from the FITS data array.   Any undefined FITS array
...
number of table cells.  See Appendix B for the definition of the
parameters used in these routines.
