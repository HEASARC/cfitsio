...
/*---------------------------------------------------------------------------*/
{
   ...
   if( ffiprs( fptr, expr, MAXDIMS, &Info.datatype, &nelem, &naxis,
               naxes, status ) ) {
      ffcprs();
      return( *status );
   }
...
/*--------------------------------------------------------------------------*/
{
   ...
   if( ffiprs( infptr, expr, MAXDIMS, &Info.datatype, &nelem, &naxis,
	       naxes, status ) ) {
      ffcprs();
      return( *status );
   }
...
/*---------------------------------------------------------------------------*/
{
   ...
   if( ffiprs( fptr, expr, MAXDIMS, &Info.datatype, &nelem1, &naxis,
	       naxes, status ) ) {
      ffcprs();
      return( *status );
   }
...
/*--------------------------------------------------------------------------*/
{
   ffiprs( fptr, expr, maxdim, datatype, nelem, naxis, naxes, status );
   ffcprs();
   return( *status );
}
