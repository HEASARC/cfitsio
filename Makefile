...
RANLIB =	ranlib
CC =		gcc
CFLAGS =	-g -O2 -Dappendus -DPG_PPU
LDFLAGS =	$(CFLAGS)
DEFS =		 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MATH_H=1 -DHAVE_LIMITS_H=1 -DHAVE_FTRUNCATE=1 -DHAVE_SHMEM_SERVICES=1 -DHAVE_NET_SERVICES=1 
LIBS =		
FLEX =		flex
BISON =		bison
